...
Current source is a separate non-installed schema-v5/SQLite-v7/`0.4.0` candidate. Its exact CfT-152 allowlist point, impact authority and observe-only residue reporting have source verification only and cannot borrow generation 15's activation or field evidence.
