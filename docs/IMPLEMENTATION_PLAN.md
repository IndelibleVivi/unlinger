...
| SAFE-01..13 | 11 | listed safety invariants | source guards, synthetic counterexamples, exact owned-child test, terminal failure receipts, full-timing isolated cleanup, scoped fast harness with simultaneous ordinary Chrome | artifact rules, chaos completion, sustained dogfood/public-alpha zero-FP evidence | partial |
| ACC-01 | 12 | latency, safety, completeness, overhead targets | 28 ms live read-only snapshot; full-timing and fast isolated cleanups ended with zero survivors and no revival | sustained benchmark, representative latency/completeness, dogfood and alpha | in progress |
| TEST-01 | 13.1-13.4 | fixture, live, adversarial, comparative evidence | 34 passing Rust tests plus one ignored live CfT harness, report-only daemon/CLI smoke, full-timing and fast isolated enforcement runs | broader real corpus, remaining chaos, benchmarks, comparative Field Lab | in progress |
