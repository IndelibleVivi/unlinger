...
| Current source/installed implementation | schema v5/v4/v3 plus operator v1; SQLite v10 optional session ownership over v9 attribution repair and v8 task ownership; Playwright `0.6.0`, other packs `0.4.0`; exact CfT 151/152 process allowlist; task-owned CLI `1.63.0-alpha-2026-08-31`; optional ordinary host-owned CLI `1.62.1`; all runtime-artifact flags false; impact/spans and observe-only storage residue |
