...
installed as accepted generation 25 with SQLite v10 and a matching schema-v5 App.
...
isolated report-only socket and 467-probe Accessibility/RSS lanes. Do not treat
...
- The installed native App was owner-authorized for replacement on 2026-09-15. The canonical Applications location contains the ad-hoc-signed matching `e26297b` schema-v5 bundle; the prior `016ca58` bundle is retained as a recoverable local sibling. Strict bundle/signature/plist equality, exact launch and generation-24/25 live-socket checks passed, but fresh visual UI, packaged-notification and installed Accessibility/RSS acceptance were not performed. Historical UI/memory points remain bounded evidence only. Do not replace the App again, remove its rollback sibling or repeat installed-App stress without a new applicable owner decision.
