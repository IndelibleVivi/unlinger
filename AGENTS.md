...
- `crates/unlinger-protocol`: current frontend schema-v5 commands/DTOs, transitional v4 browser-overview responses, legacy-compatible v3 responses, mutation contexts/receipts/status, impact/residue/storage-cleanup-result/span DTOs, capabilities, outcome enums, response envelopes, and canonical fixture decoders. It contains no service lifecycle command.
